                  ...
                  <div className={classes.inline}>
                    <Typography variant="h6" color="inherit" noWrap>
                      <Link to='/' className={classes.link}>
                        <img width={30} src="https://is2-ssl.mzstatic.com/image/thumb/Purple125/v4/6c/a9/8b/6ca98b99-662c-9892-5c37-9057d918ff5b/source/512x512bb.jpg" alt="" />
                        <span className={classes.tagline}>Health India</span>
                      </Link>
                    </Typography>
                  </div>
                  { !this.props.noTabs && (
